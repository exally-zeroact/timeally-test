 ...
 * =============================================================================
 * ★★ここを 直そうとした人へ（2026-09-06・指示役）★★
 *   ★`--next-month` に 日付を 書かないで ください＝★今日から 数えます★★
 *   ★書いたら それ自体が「今日が 何月か」を 書く事に なります★
 *   ＝★守ろうとしている 病気を 見張りが 自分で 持つ★事に なります。
 *   （「2026-10-01 と 書いた方が 分かりやすい」＝★それが 落とし穴です★）
 *
 * 使い方:
 *   node scripts/clock-travel.mjs                       … 決めた日を全部（既定の4つ・約605秒）
 *   node scripts/clock-travel.mjs --next-month          … ★次の月の1日だけ（約150秒・毎回のCIはこれ）★
