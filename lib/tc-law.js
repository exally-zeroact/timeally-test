...
(function (root, factory) {
  ...
  /* ── 年次有給休暇（労基法39条） ──────────────────────────────
     ★中身は lib/tc-yukyu.js に置いた★（2026-08-19）。
     理由: ★従業員の画面に「有給の残り」を1行だけ出す★事になったが、
       tc-law.js は 率・丸め・割増の言葉を持っている＝★従業員の画面から読ませない★
       （tests/employee-screen.test.mjs の②が見張っている）。
       ⇒ ★有給の数字だけを 別の1本に分けた★。★正本は tc-yukyu.js の1本きり★で、
         ここは ★そのまま渡すだけ★（同じ数を2か所に書かない）。 */
  var YUKYU = (typeof require === 'function' && typeof module !== 'undefined')
    ? require('./tc-yukyu.js')
    : (typeof self !== 'undefined' ? self.TcYukyu : this.TcYukyu);
  ...
  return {
    ...
    YUKYU_TABLE: YUKYU.YUKYU_TABLE,
    YUKYU_ATTEND_RATIO: YUKYU.YUKYU_ATTEND_RATIO,
    YUKYU_MUST_TAKE_DAYS: YUKYU.YUKYU_MUST_TAKE_DAYS,
    YUKYU_MUST_TAKE_FROM_DAYS: YUKYU.YUKYU_MUST_TAKE_FROM_DAYS,
    ...
    YUKYU_FIRST_AFTER_MONTHS: YUKYU.YUKYU_FIRST_AFTER_MONTHS,
    YUKYU_PERIOD_MONTHS: YUKYU.YUKYU_PERIOD_MONTHS,
    YUKYU_EXPIRE_YEARS: YUKYU.YUKYU_EXPIRE_YEARS,
    yukyuGrantDays: YUKYU.yukyuGrantDays,
    yukyuPeriod: YUKYU.yukyuPeriod,
    yukyuLeft: YUKYU.yukyuLeft,
    mustTake5: YUKYU.mustTake5,
    must5State: YUKYU.must5State,
